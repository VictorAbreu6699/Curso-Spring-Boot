...
public class DBService {
	...
	public void instantiateTesteDataBase() throws ParseException {
		...
		Cliente cli2 = new Cliente(null, "Victor Abreu", "azevedovictor6699@gmail.com", "42481475054", TipoCliente.PESSOAFISICA, bCryptPasswordEncoder.encode("123"));
		cli2.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		cli2.addPerfil(Perfil.ADMIN);
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida Ferreira", "108", "Sala 5", "Centro", "38777012", cli2, c2);
